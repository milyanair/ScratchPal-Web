...
export function Admin() {
  ...
  const [activeTab, setActiveTab] = useState<'slider' | 'games' | 'rankings' | 'rewards' | 'users' | 'announcements' | 'scanner' | 'states'>('slider');
  ...
  return (
    <Layout hideNav>
      <div className="max-w-screen-xl mx-auto px-4 py-6">
        ...
        {/* Tabs - KEEPING ALL TABS EXACTLY AS THEY ARE */}
          ...
          <div>
            ...
            <div className="bg-white rounded-lg shadow overflow-x-auto mb-4">
              <table className="w-full">
                ...
                <tbody className="divide-y">
                  {paginatedGames.length === 0 ? (<tr><td colSpan={9} className="px-4 py-8 text-center text-gray-500">No games found</td></tr>) : (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gradient-to-r from-indigo-500 to-indigo-600 text-white rounded-lg shadow p-6">
                  ...
                  <p className="text-sm opacity-90 mb-4">Import game data from CSV file URL. New games will be added, existing games (matching game_number + state) will be updated.</p>
                  <div className="bg-white/10 rounded-lg p-4 mb-4">
